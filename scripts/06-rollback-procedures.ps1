# =============================================================================
# 06 - Rollback Procedures Script
# =============================================================================
# Provides emergency rollback capabilities for the Terraform Atlantis Workshop
# 
# Workflow Order:
...
# 6. 06-rollback-procedures.ps1 (this script)
...
Write-Host "🔄 Step 6: Terraform Atlantis Workshop - Rollback Procedure" -ForegroundColor Cyan
